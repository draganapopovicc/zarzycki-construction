...
jQuery(document).ready(function ($) {
	...
	$(".st_home-hero__buttons").hover(
		function () {
			flickity.flickity("pausePlayer");
		},
		function () {
	...
	$(window).on("load", function () {
		$(".st_home-hero").addClass("has-slider");

		if ($(".wrap").hasClass("flickity-enabled")) {
			setTimeout(function () {
				flickity.flickity("option", { autoPlay: 3000 });
				flickity.flickity("playPlayer");
			}, 1000);
		}
	});
