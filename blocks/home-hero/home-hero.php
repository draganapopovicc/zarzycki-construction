...
<div class="<?php echo $class; ?>">
     <?php if( have_rows('slider_images') ): ?>
        <?php while( have_rows('slider_images') ) : the_row();
                $prefix = get_sub_field('prefix_hero'); 
                $title = get_sub_field('title_hero'); 
                $image = get_sub_field('image_hero');  
                $link =  get_sub_field('button_hero');
                if($link) {
                ...
                <div class="before-slider">
                    <?php if( $image ) : ?>
                        <figure class="st_home-hero__image">
                            <?php
                    ...
                    <div class="st_inner-hero__content container">
                        <div class="b-title b-title-h1">
                            ...
                            <?php endif ?>
                            <?php if( $title ): ?>
                                <h1 class="b-title__main title-3"> <?php echo $title ?> </h1>
                            <?php endif ?>

                            <?php if($link): ?>
                                <div class="btn btn-1">  <?php echo $link_title  ?></div>
                            <?php endif ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="st_home-hero__buttons">
